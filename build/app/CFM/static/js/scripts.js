...
$('.show_form_online').click(function(){
...
$('.tel_form').click(function(){
$('.tel_form').css({'top':'-100%'});

$('.tel_form').fadeOut(3000);
});

        $('.tel_form').children().click(function(e){
...
function init_map()
{
	var coordLat = 56.814950;
	var coordLng = 60.550076;
...
function init_map2()
{
	var coordLat = 55.5035139;
	var coordLng = 65.3081418;
...
$(function()
{
	...
	if( document.getElementById('map') )
	{
		var script = document.createElement('script');
	 	...
	 	script.src = 'https://maps.googleapis.com/maps/api/js?sensor=false&callback=init_map&language=ru';
	...
	if( document.getElementById('map2') )
	{
		var script = document.createElement('script');
	 	script.type = 'text/javascript';
	 	script.src = 'https://maps.googleapis.com/maps/api/js?sensor=false&callback=init_map2&language=ru';
	 	document.body.appendChild(script);
 	}
...
function contact_form_init(){
		if($('#contactform').length) {
			...
			$form.submit(function(e){
				...
				//send data to server
				$.post("php/contact-send-app.php", data, function(response) {
